...
\begin{problema}
	...
	Regresando a la ecuación radia, sustituyendo la solución propuesta y dividiendo
	por \(r^{\ell + 1}\mathrm{e}^{-m\omega r^{2}/2\hbar}\), así como multiplicando por
	el inverso de \(-\tfrac{\hbar^{2}}{2m}\), i.e. \(-\tfrac{2m}{\hbar^{2}}\),
