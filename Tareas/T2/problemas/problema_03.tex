...
\zexternaldocument[P6-]{build/problema_02}
...
Calculamos \(\psi^{*}\) de la \zcref{P6-eq:wave-packet-res},
...
Calculando el producto de las \zcref{P6-eq:wave-packet-res,eq:wave-packet-conjugate},
